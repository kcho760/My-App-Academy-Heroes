    ...
    <div className="team-modal-container">
      <div className="team-tabs-wrapper">
        <div className="team-tabs">
          ...
          <a href="https://github.com/kcho760" target="_blank" rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="git-button"
              viewBox="0 0 448 512"
          ...
          <a href="https://wellfound.com/u/kevin-cho-43" target="_blank" rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="wellfound-button"
              height="1em"
              viewBox="0 0 448 512"
            >
        ...
        <div className="team-tabs">
          ...
          <img
            ...
            alt="none"
          />
          <a href="https://www.linkedin.com/in/jiaminzou95/" target="_blank" rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="linkedin-button"
              viewBox="0 0 448 512"
          ...
          <a href="https://github.com/Jiamin-Zou" target="_blank" rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="git-button"
              viewBox="0 0 448 512"
          ...
          <a href="https://wellfound.com/u/jiamin-zou-1" target="_blank" rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="wellfound-button"
              height="1em"
        ...
        <div className="team-tabs">
          ...
          <a href="https://github.com/ssomy3800" target="_blank" rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="git-button"
              viewBox="0 0 448 512"
          ...
          <a href="https://wellfound.com/u/hong-chen-20" target="_blank" rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="wellfound-button"
              height="1em"
        ...
        <div className="team-tabs">
          ...
          <a href="https://wellfound.com/u/henry-lin-21" target="_blank" rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="wellfound-button"
              height="1em"
